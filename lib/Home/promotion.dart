...
class Promotion extends StatefulWidget {
  final Map<String, dynamic>?
      selectedCoupons; // ใช้ Map ที่รองรับค่าที่เป็น null
  ...
  List<dynamic> promotionData = [
    {
      ...
      "detail": "สำหรับลูกค้าทุกท่าน (ตัวอย่าง2)",
    ...
    {
      "name": "คูปองส่วนลด 20 บาท",
      "detail": "สำหรับลูกค้าทุกท่าน (ตัวอย่าง1)",
      "image": "assets/images/pha1.jpg",
      "percent": "0",
      "id": "MOCK01",
      "date_start": "2024-01-01",
                ...
                children: [
                  ...
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      ...
                      backgroundColor: Colors.red, // กำหนดสีพื้นหลังให้เป็นแดง
                    ),
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        fontSize: 14,
                        color: Colors.white, // ถ้าต้องการให้ตัวอักษรเป็นสีขาว
                      ),
                    ),
                  )
                ],
                                              ...
                                              child: Text(
                                                selectedCoupon != null &&
                                                        selectedCoupon!['id'] ==
                                                            promo['id']
                                                    ? 'ใช้'
                                                    : 'เลือก', // เปลี่ยนปุ่มจาก "เลือก" เป็น "ใช้"
                                                style: TextStyle(
                                                  fontWeight: FontWeight.bold,
                                                  fontSize: 16,
                                                ),
