...
class AlertInfo extends ConsumerStatefulWidget {
  String head;
  String detail;

  AlertInfo(this.head, this.detail, {super.key});

  @override
  ConsumerState<AlertInfo> createState() => _ProductCartState();
}

class _ProductCartState extends ConsumerState<AlertInfo> {
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    //   ),
                                    // ),
                                    Icon(Icons.info_outline_rounded, color: CustomTheme.colorPrimary, size: 50),
                                    Padding(
                                      padding: const EdgeInsets.all(0),
                                      child: Row(
