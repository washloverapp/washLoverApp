...
class AlertError extends ConsumerStatefulWidget {
  String head;
  String detail;

  AlertError(this.head, this.detail, {super.key});

  @override
  ConsumerState<AlertError> createState() => _ProductCartState();
}

class _ProductCartState extends ConsumerState<AlertError> {
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            widget.detail,
                                            style: Theme.of(context).textTheme.titleLarge!.copyWith(
                                                color: Colors.red, fontWeight: FontWeight.normal, fontSize: 18),
                                          ),
                                        ],
                                      ),
                                    ),
